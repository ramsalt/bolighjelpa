...
<body class="<?php print $classes; ?> <?php if($venstremeny): ?>venstre<?php endif; ?>">
...
<?php endif; ?>
     ...
     <?php if($venstremeny): ?>
     <div id="venstremeny"><div class="section"><?php print $venstremeny; ?></div></div>
     <?php endif; ?>
...
<?php if ($footer || $footer_message || $secondary_links || $footer_sito): ?>
  <div id="footer-bg"><div id="footer-wrapper">
...
<div id="footer-blocks">
    ...
    <?php endif; ?>
      ...
      </div></div></div></div> <!-- /.section, /#footer, /#footer-wrapper, /#footer-bg -->
    <?php endif; ?>
